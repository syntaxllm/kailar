...
export async function generateSummary(meetingData) {
    ...
    const messages = [
        { role: 'system', content: 'You are an expert meeting analyst. The transcript may contain noise, repetition, or phonetic errors. Ignore unintelligible segments and reconstruct meaning from context.' },
        {
            role: 'user', content: `Analyze the following meeting transcript and generate a comprehensive summary.
            
NOTE: The transcript may have fragmentation or "Hinglish" usage. Treat it as valid technical context.
